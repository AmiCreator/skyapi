...
class SkyManager:
    """
        https://boxer-merry-abnormally.ngrok-free.app/sky
    """
    BASE_URL = "https://boxer-merry-abnormally.ngrok-free.app/sky"
    ...
    async def _request(self, method: str, params: dict = {}) -> dict:
        url = f'https://boxer-merry-abnormally.ngrok-free.app/sky/{method}'
